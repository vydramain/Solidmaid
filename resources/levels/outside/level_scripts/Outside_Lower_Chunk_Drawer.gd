...
func _fill_cross_area(background_scene: TileMapLayer, start_x: int, start_y: int) -> void:
	Logger.log(self, "[CROSS] Start placing cross area tiles | Start position: (" + str(start_x) + ", " + str(start_y) + ")")
	...
	Logger.log(self, "[CROSS] Sidewalk tiles placed | Total tiles: " + str(sidewalk_count))
	...
	Logger.log(self, "[CROSS] Road tiles placed | Total tiles: " + str(road_count))
	Logger.log(self, "[CROSS] Completed cross area")
